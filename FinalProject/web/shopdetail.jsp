                                    ...
                                    <li class="nav-item active">
                                        <a class="d-flex py-2 m-2 bg-light rounded-pill active" data-bs-toggle="pill" href="#tab-2">
                                            <span class="text-dark "style ="width: 130px;">
                                                <a class="${tag == o.cateID ? "active":""}  fas fa-apple-alt me-2 "  href="category?cateID=${o.cateID}" style=" border-radius: 10px; padding: 3px;color: #006600;">    ${o.cateName} </a>   
                                            </span>
                                        </a>
                                    </li>
                                </c:forEach>
